# cyberimmunity-ci-inetd-service
...
```
git clone https://gitflic.ru/project/yyxa/cyberimmunity-ci-inetd-service.git
cd cyberimmunity-ci-inetd-service
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/yyxa/cyberimmunity-ci-inetd-service.git
git clone
